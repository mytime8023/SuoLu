...
<script type="text/javascript">
	...
	$(function() {
		...
		var v=$("#editPasswordForm").form("validate");
			if(v){
				var t1=$("#textNewPass").val();
				var t2=$("#textRePass").val();
				if(t1==t2){
					$.post("userAction_editPassword.action",{"password":t1},function(data){
						if(data=='1'){
							//修改密码成功
							$("#editPwdWindow").close();	
						}
					...
					$.messager.alert("提示信息", "两次密码不一样","warning")
				}
			}
            ...
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                <form  id="editPasswordForm">
		              <table cellpadding=3>
		                  <tr>
		                      <td>新密码：</td>
		                      <td><input data-options="validType:'length[4,6]'" id="txtNewPass" type="Password" class="txt01 easyui-validatebox" required="true" /></td>
		                  </tr>
		                  <tr>
		                      <td>确认密码：</td>
		                      <td><input data-options="validType:'length[4,6]'" id="txtRePass" type="Password" class="txt01 easyui-validatebox" required="true" /></td>
		                  </tr>
		              </table>
                </form>
            </div>
